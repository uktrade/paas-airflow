web: /home/vcap/app/bin/checkout_dags.sh && /home/vcap/app/bin/paas-wrapper.sh airflow db upgrade && /home/vcap/app/bin/paas-wrapper.sh airflow webserver -p 8080
